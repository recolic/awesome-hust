...
开源的无线校园网认证工具 [hust-login(with RSA support)](https://github.com/Cra1gTucker/hust-login) [hust\_wireless.py](https://github.com/haoqixu/hust_wireless) [hust\_wireless.sh-用于低性能设备的精简版](https://github.com/recolic/awesome-hust/blob/master/res/hust_wireless.sh) [HUST-login(单文件版，支持RSA加密)](https://github.com/185264646/HUST-login)
